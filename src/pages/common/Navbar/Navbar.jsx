  ...
  return (
    <div className="navbar bg-base-100 mx-auto md:px-10">
      ...
      <div className="navbar-end">
        {/* dark mode  */}
        <label className=" lg:mr-4 mr-1 swap swap-rotate">
          ...
          {/* sun icon */}
          <svg
            className="swap-on fill-current w-6 h-6 lg:w-8 lg:h-8"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
          ...
          {/* moon icon */}
          <svg
            className="swap-off fill-current w-6 h-6 lg:w-8 lg:h-8"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
